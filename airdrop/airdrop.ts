import { createKeyPairFromBytes, createSolanaRpc, createSolanaRpcSubscriptions, devnet, airdropFactory, lamports, createKeyPairSignerFromBytes } from "@solana/kit";
...
try {
    ...
    console.error(`Oops, somehting went wrong: ${error}`);
}